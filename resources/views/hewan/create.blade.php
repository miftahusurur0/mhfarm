...
<html lang="en">
  ...
  <body>
    <div class="container mt-5">
        <h1 class="text-center mt-5">Form Tambah Data Hewan</h1>
            ...
            <div class="card-body">
                <form action="{{ route('hewan.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" name="nama_hwn" id="nama_hwn">
                    </div>
                    <div class="mb-3">
                      <label for="jenis_hwn" class="form-label">Jenis Hewan</label>
                      <input type="text" class="form-control" name="jenis_hwn" id="jenis_hwn">
                    </div>
                    <div class="mb-3">
                      <label for="asal_hwn" class="form-label">Asal Hewan</label>
                      <input type="text" class="form-control" name="asal_hwn" id="asal_hwn">
                    </div>
                    <div class="mb-3">
                      <label for="umur_hwn" class="form-label">Umur Hewan</label>
                      <input type="number" class="form-control" name="umur_hwn" id="umur_hwn">
                    </div>
                    <div class="mb-3">
                      <label for="berat_hwn" class="form-label">Berat Hewan</label>
                      <input type="number" class="form-control" name="berat_hwn" id="berat_hwn">
                    </div>
                    <div class="mb-3">
                      <label for="harga_hwn" class="form-label">Harga Hewan</label>
                      <input type="number" class="form-control" name="harga_hwn" id="harga_hwn">
                    </div>
